...
execute unless score @s cngs.017 = @s cngs.016 store result score @s cngs.019 run data get entity @s SelectedItem.tag.CngNBT.LoadingTime
...
tag @a[tag=cngt.reloading] remove cngt.reloading