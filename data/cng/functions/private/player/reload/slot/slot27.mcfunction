...
execute if score @s cng.istrueammo matches 0 run data modify block ~ 0 ~ Items[0].Count set from entity @s Inventory[{Slot: 27b}].Count
...
execute if score @s cng.istrueammo matches 0 if data entity @s Inventory[{Slot: 27b}].tag.CngAmmoNBT if score @s cng.ammocount < @s cng.needammo run tag @s add cng.ammocountR0
execute if score @s cng.istrueammo matches 0 if data entity @s Inventory[{Slot: 27b}].tag.CngAmmoNBT if score @s cng.ammocount >= @s cng.needammo run tag @s add cng.ammocountR1
...
execute if entity @s[tag=cng.ammocountR1] run item replace entity @s container.27 from block ~ 0 ~ container.0
...
execute if entity @s[tag=cng.ammocountR0] run item replace entity @s container.27 with air
