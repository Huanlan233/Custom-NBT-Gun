...
execute if data entity @s Inventory[{Slot: 20b}].tag.CngAmmoNBT store success score @s cngs.018 run data modify block ~ 0 ~ Items[0].tag.CngAmmoNBT.ID set from entity @s Inventory[{Slot: 20b}].tag.CngAmmoNBT.ID
execute if score @s cngs.018 matches 0 run data modify block ~ 0 ~ Items[0].tag set from entity @s Inventory[{Slot: 20b}].tag
execute if score @s cngs.018 matches 0 run data modify block ~ 0 ~ Items[0].Count set from entity @s Inventory[{Slot: 20b}].Count
execute if score @s cngs.018 matches 0 run data modify block ~ 0 ~ Items[0].id set from entity @s Inventory[{Slot: 20b}].id
...
execute if score @s cngs.018 matches 0 if data entity @s Inventory[{Slot: 20b}].tag.CngAmmoNBT if score @s cngs.014 < @s cngs.015 run tag @s add cngt.ammocountR0
execute if score @s cngs.018 matches 0 if data entity @s Inventory[{Slot: 20b}].tag.CngAmmoNBT if score @s cngs.014 >= @s cngs.015 run tag @s add cngt.ammocountR1
...
execute if entity @s[tag=cngt.ammocountR1] run item replace entity @s container.20 from block ~ 0 ~ container.0
...
execute if entity @s[tag=cngt.ammocountR0] run item replace entity @s container.20 with air
