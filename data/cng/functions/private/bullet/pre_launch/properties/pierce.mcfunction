...
execute store result score @s cng.pierce run data get entity @a[limit=1,sort=nearest] SelectedItem.tag.CngNBT.Pierce.Base
...
scoreboard players operation @s cng.pierce += @s cng.temp2
