...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo matches 0.. if data entity @s Inventory[{Slot:26b}].tag.CngAmmoNBT run function cng:events/player/reload/loading1
...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot:26b}].tag.CngAmmoNBT run scoreboard players operation @s cng.needammo2 *= #-1 cng.constant
...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot:26b}].tag.CngAmmoNBT run item replace entity @s container.26 with air
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot:26b}].tag.CngAmmoNBT run function cng:events/player/reload/loading2
