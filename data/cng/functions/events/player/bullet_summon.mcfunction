...
execute if entity @s[tag=cng.haveammo] positioned ~ ~1.5 ~ run summon arrow ^ ^ ^0.1 {Tags:["cng.bullet_not_fired"],damage:0.0001d,CustomPotionEffects:[{Id:14b,Amplifier:1b,Duration:20},{Id:20b,Amplifier:1b,Duration:0}]}
execute unless data entity @s SelectedItem.tag.CngNBT.AmmoID positioned ~ ~1.5 ~ run summon arrow ^ ^ ^0.1 {Tags:["cng.bullet_not_fired"],damage:0.0001d,CustomPotionEffects:[{Id:14b,Amplifier:1b,Duration:20},{Id:20b,Amplifier:1b,Duration:1}]}
# 弹匣内子弹数量减一
