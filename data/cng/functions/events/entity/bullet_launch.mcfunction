...
# 设置速度效果秒数为伤害
execute at @s store result entity @s CustomPotionEffects[1].Duration int 1 run data get entity @a[limit=1,distance=..2.5,sort=nearest] SelectedItem.tag.CngNBT.Damage
