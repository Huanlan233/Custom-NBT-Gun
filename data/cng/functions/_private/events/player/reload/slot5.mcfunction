...
execute if score @s cng.surplusammo matches 0.. if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT run function cng:_private/events/player/reload/loading1

execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT store result score @s cng.needammo2 run data get entity @s Inventory[{Slot: 5b}].Count
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT run scoreboard players operation @s cng.needammo2 -= @s cng.needammo
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT run scoreboard players operation @s cng.needammo2 *= #-1 cng.constant
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT store result score @s cng.ammocount2 run data get entity @s Inventory[{Slot: 5b}].Count
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT run item replace entity @s container.5 with air
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 5b}].tag.CngAmmoNBT run function cng:_private/events/player/reload/loading2
