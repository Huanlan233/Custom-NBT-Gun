...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo >= #0 cng.constant run item replace entity @s container.1 from block ~ 0 ~ container.0
...
# # # 如果剩余弹药surplusammo<0
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant if data entity @s Inventory[{Slot: 1b}].tag.CngAmmoNBT store result score @s cng.ammocount2 run data get entity @s Inventory[{Slot: 1b}].Count
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant if data entity @s Inventory[{Slot: 1b}].tag.CngAmmoNBT store result score @s cng.needammo2 run data get entity @s Inventory[{Slot: 1b}].Count
...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant run item replace entity @s container.1 with air
