...
execute if score @s cng.istrueammo matches 0 if score @s cng.istrueammo matches 0 if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 26b}].tag.CngAmmoNBT run function cng:_private/events/player/reload/loading2
