...
execute if score @s cng.surplusammo matches 0.. if data entity @s Inventory[{Slot: 13b}].tag.CngAmmoNBT run function cng:_private/events/player/reload/loading1
...
execute if score @s cng.surplusammo matches ..-1 if data entity @s Inventory[{Slot: 13b}].tag.CngAmmoNBT run function cng:_private/events/player/reload/loading2
