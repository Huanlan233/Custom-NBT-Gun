...
execute if data entity @s Inventory[{Slot: 6b}].tag.CngAmmoNBT store success score @s cng.istrueammo run data modify block ~ 0 ~ Items[0].tag.CngAmmoNBT.ID set from entity @s Inventory[{Slot: 6b}].tag.CngAmmoNBT.ID
...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo >= #0 cng.constant run item replace entity @s container.6 from block ~ 0 ~ container.0
...
# # #
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant if data entity @s Inventory[{Slot: 6b}].tag.CngAmmoNBT store result score @s cng.ammocount2 run data get entity @s Inventory[{Slot: 6b}].Count
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant if data entity @s Inventory[{Slot: 6b}].tag.CngAmmoNBT store result score @s cng.needammo2 run data get entity @s Inventory[{Slot: 6b}].Count
...
execute if score @s cng.istrueammo matches 0 if score @s cng.surplusammo < #0 cng.constant run item replace entity @s container.6 with air
