...
# 召唤箭矢
execute if entity @s[tag=cng.haveammo] positioned ~ ~1.5 ~ run summon arrow ^ ^ ^0.1 {Tags: ["cng.bullet_not_fired"], damage: 0.0001d, CustomPotionEffects: [{Id: 24b, Amplifier: 0b, Duration: 0}, {Id: 19b, Amplifier: 1b, Duration: 2}]}
execute unless data entity @s SelectedItem.tag.CngNBT.MaxAmmo positioned ~ ~1.5 ~ run summon arrow ^ ^ ^0.1 {Tags: ["cng.bullet_not_fired"], damage: 0.0001d, CustomPotionEffects: [{Id: 24b, Amplifier: 0b, Duration: 0}, {Id: 19b, Amplifier: 1b, Duration: 2}]}
# 弹匣内子弹数量减一
